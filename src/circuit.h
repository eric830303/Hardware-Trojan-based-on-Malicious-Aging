...
void ReadCpInfo( string , int )     ;
void PrintStatus( double )          ;
void AdjustConnect( )               ;
void CheckOriLifeTime( )            ;
void GenerateSAT( string ,double  ) ;
void CheckPathAttackbility( double, double, bool, double )      ;
...
/////////////////////////////////////////////////////////////////////////
double CalQuality( double, double &, double &, int )            ;
double Monte_PVCalQuality( double, double &, double &)          ;
